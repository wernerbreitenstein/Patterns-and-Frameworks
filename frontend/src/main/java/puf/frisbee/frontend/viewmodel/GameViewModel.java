...
public class GameViewModel {
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long l) {
                ...
                if (isCharacterRightMovingLeft)
                    characterRightXPosition.setValue(characterRightXPosition.getValue() - 1);
    ...
    public void moveCharacterRight(String character) {
        if (character.equals("left")) {
            this.isCharacterLeftMovingRight = !this.isRightBorderReachedByCharacterLeft();
        }

        if (character.equals("right")) {
            this.isCharacterRightMovingRight = !this.isRightBorderReachedByCharacterRight();
        }
    }
